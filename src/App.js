...
import { Button, Form, Checkbox, DatePicker, Input, Select } from 'antd';
import './App.css';
  ...
  <div className="App">
    <header className='App-header'>
      ...
      >
        ...
        dependencies={['password']} //refers to 1st enter password
        rules={[
          {
            required:true,
          },
          ({getFieldValue})=>({
            validator(_,value){
              ...
              return Promise.reject('Two passwords you entered do not match')
            }
          })
        ]}
        hasFeedback
        ...
        hasFeedback>
          <DatePicker style={{width:'100%'}} picker='date' placeholder='Choose your date of birth'/>
        </Form.Item>
        ...
        rules={[
          ...
          <Checkbox>Agree to our <a href='https://google.com'>Terms and Conditions</a></Checkbox>
        </Form.Item>
